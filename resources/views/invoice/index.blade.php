...
@section('title')
<title>Cafe Ngopi | Invoice</title>
@endsection
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="card-header"
                ...
                <h1 style=" font-family: 'Vast Shadow' , cursive; ">Invoice</h1>
            </div>

            <div class=" col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="/dashboard" style="color: rgb(160, 135, 135)">Home</a></li>
                    <li class="breadcrumb-item"><a href="#" style="color:rgb(160, 135, 135)">Invoice</a></li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="invoice p-3 mb-3">
            ...
            <div class="row no-print">
                <div class="col-12">
                    ...
                    <button type="button" onclick="window.print();" class="btn  btn-generate float-right"
                        style="margin-right: 5px; background-color:rgb(160, 135, 135);color:gold">
                        <i class="fas fa-download"></i> Generate PDF
                    </button>
                    <a href="{{ route('dashboard.index') }}" class="btn btn-secondary" style="color:gold">Back to
                        Home</a>
                </div>
            </div>
        </div>
